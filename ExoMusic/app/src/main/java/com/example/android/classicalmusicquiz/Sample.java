...
class Sample {
    ...
    private static JsonReader readJSONFile(Context context) throws IOException {
        ...
        if(App.getAppContext() == null) {
            Log.i("Sample", "null context");
        }
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(App.getAppContext(),
                Util.getUserAgent(App.getAppContext(), "ClassicalMusicQuiz"));
