...
public final class SunshinePreferences {
     ...
     */
    public static void setLocationDetails(double lat, double lon) {
     ...
     *
     */
    public static void resetLocationCoordinates() {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sp.edit();
     ...
     */
    public static boolean isLocationLatLonAvailable() {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
     ...
     */
    public static void saveLastNotificationTime(long timeOfNotification) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sp.edit();
     ...
     */
    public static long getLastNotificationTimeInMillis() {
     ...
     */
    public static long getEllapsedTimeSinceLastNotification() {
        long lastNotificationTimeMillis =
                SunshinePreferences.getLastNotificationTimeInMillis();
