 ...
 */
package com.example.android.sunshine.model.common;
...
public final class NetworkUtils {
    ...
    public static URL getUrl() {
        if (SunshinePreferences.isLocationLatLonAvailable()) {
            double[] preferredCoordinates = SunshinePreferences.getLocationCoordinates();
    ...
    private static URL buildUrlWithLatitudeLongitude(Double latitude, Double longitude) {
        ...
        try {
            ...
            Timber.tag(TAG).d("locationQuery URL: " + weatherQueryUrl);
    ...
    //Todo
// 1. return type connection transport/cellur
